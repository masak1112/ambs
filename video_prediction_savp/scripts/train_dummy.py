...
def load_params_from_checkpoints_dir(checkpoint,dataset,model):
    if checkpoint:
    ...
    return dataset, model, checkpoint_dir
...
def main():
    ...
    model_hparams_dict = get_model_hparams_dict(args.model_hparams_dict)
    ...
    args.dataset,args.model,checkpoint_dir = load_params_from_checkpoints_dir(args.checkpoint,args.dataset,args.model)
    ...
    train_dataset,val_dataset,variable_scope = setup_dataset(dataset,args.input_dir,args.val_input_dir)
    ...
    inputs,val_handle = make_dataset_iterator(train_dataset, val_dataset, batch_size)
