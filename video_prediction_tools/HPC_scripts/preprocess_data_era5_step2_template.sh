...
srun python ../main_scripts/main_preprocess_data_step2.py -input_dir ${source_dir} -output_dir ${destination_dir}  -hparams_dict_config ${hparams_dict_config} -sequences_per_file ${sequences_per_file}
